...
export default function ChickenCard({ chicken, selected, onSelect }) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-[0.45rem] flex items-center gap-[0.55rem]">
        <ChickenPreview bodyColor={bodyColor} />
        <div className="min-w-0 flex-1">
          <div className="mb-[0.2rem] flex items-center justify-between gap-[0.6rem]">
            <p className={`truncate text-[clamp(0.56rem,1.1vw,0.68rem)] transition-colors duration-150 ${selected ? 'text-[#ffe8aa]' : 'text-text-main'}`}>{chicken.name}</p>
